...
import org.pfw.framework.wjgl.dao.JiaoshiDao;
...
public class JiaoshiServiceImpl implements JiaoshiService {
	...
	@Autowired
	private JiaoshiDao entityDao;

	@Transactional(readOnly=true)
	public Jiaoshi getById(String id) {
	...
	@Transactional(readOnly=true)
	public List<Jiaoshi> find(List<PropertyFilter> filters)
	{
		return entityDao.find(filters);
	}
	
	public void save(Jiaoshi entity)
	{
		entityDao.save(entity);
	}
	
	public void update(Jiaoshi entity)
	{
