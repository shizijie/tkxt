...
@Results
	({ 
		...
		@Result(name="success",location="/wjgl/twjlsyj-list.ftl",type = "freemarker"),
		@Result(name ="input",location="/wjgl/twjlsyj-input.ftl", type = "freemarker")
	})
public class TwjlsyjAction extends CrudActionSupport<Twjlsyj> {
	@Autowired
	protected TwjlsyjService entityService;
	...
	protected void prepareModel() throws Exception {
		if (!StringUtils.isEmpty(id)) {
			entity = (Twjlsyj) entityService.getById(id);
		} else {
			entity = new Twjlsyj();
		}
