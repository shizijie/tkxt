...
@Results
	({ 
		...
		@Result(name="success",location="/wjgl/TopicOptions-list.ftl",type = "freemarker"),
		@Result(name ="input",location="/wjgl/TopicOptions-input.ftl", type = "freemarker")
	})
public class TopicOptionsAction extends CrudActionSupport<TopicOptions> {
	@Autowired
	protected TopicOptionsService entityService;
	...
	protected void prepareModel() throws Exception {
		if (!StringUtils.isEmpty(id)) {
			entity = (TopicOptions) entityService.getById(id);
		} else {
			entity = new TopicOptions();
		}
