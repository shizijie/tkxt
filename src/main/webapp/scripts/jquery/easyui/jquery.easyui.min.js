		...
		return this.each(function() {
			...
			if (_1bc) {
				...
				_1bc = $.data(this, "window", {
					options: $.extend({}, $.fn.window.defaults, $.fn.window.parseOptions(this), _1b9)
				});
		...
		return this.each(function() {
			...
			if (_2d7) {
				...
				$.data(this, "menubutton", {
					options: $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _2d5)
				});
				$(this).removeAttr("disabled");
			}
			init(this);
		...
		return this.each(function() {
			...
			if (_2e2) {
				...
				$.data(this, "splitbutton", {
					options: $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _2e0)
				});
				$(this).removeAttr("disabled");
			}
			init(this);
		...
		return this.each(function() {
			...
			if (_2f8) {
				...
				$.data(this, "validatebox", {
					options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _2f6)
				});
			}
			_2e7(this);
		});
		...
		return this.each(function() {
			...
			if (_320) {
				...
				_320 = $.data(this, "numberbox", {
					options: $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _31d)
				});
				$(this).removeAttr("disabled");
				$(this).css({
					imeMode: "disabled"
		...
		return this.each(function() {
			...
			if (_343) {
				...
				_343 = $.data(this, "calendar", {
					options: $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _341)
				});
				init(this);
			}
		...
		return this.each(function() {
			...
			if (_362) {
				...
				$.data(this, "numberspinner", {
					options: $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _35f)
				});
			}
			_35b(this);
		});
		...
		return this.each(function() {
			...
			if (_37c) {
				...
				$.data(this, "timespinner", {
					options: $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _379)
				});
				_365(this);
			}
		});
		...
		return this.each(function() {
			...
			if (_635) {
				...
				_635 = $.data(this, "combobox", {
					options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _632)
				});
				_630(this);
				_624(this, _622(this));
			}
	...
	$.fn.combotree = function(_64b, _64c) {
		...
		return this.each(function() {
			...
			if (_64e) {
				...
				$.data(this, "combotree", {
					options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _64b)
				});
			}
			_63f(this);
		});
		...
		return this.each(function() {
			...
			if (_66c) {
				...
				_66c = $.data(this, "combogrid", {
					options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _669)
				});
			}
			_652(this);
		});
	...
	$.fn.datebox = function(_680, _681) {
		...
		return this.each(function() {
			...
			if (_683) {
				...
				$.data(this, "datebox", {
					options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _680)
				});
			}
			_670(this);
		});
		...
		return this.each(function() {
			...
			if (_69c) {
				...
				$.data(this, "datetimebox", {
					options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _699)
				});
			}
			_686(this);
		});
