...
<div class="detail_right">
  <div class="detail_title">${firstMedia?if_exists.articleName?if_exists}</div>
  <div class="detail_per"> <span>发布人：${media?if_exists.addUser?if_exists.loginName?if_exists}</span><span>发布时间：${firstMedia?if_exists.addDate?if_exists}</span></div>
