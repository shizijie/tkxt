			...
			<div class="span12">
				...
				<div class="span12">
					<div class="portlet box green">
						...
						<!--内容表单-->
						<form id="save_inputForm" class="form-horizontal  form-bordered" action="${base}/wjgl/twjyhctj!save.action" method="post">
							<@s.token />
							<#if id?exists>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span10 m-wrap" id="bz" name="bz" value="${bz!}" maxlength="20" />
								</div>
							</div>
							<div class="row-fluid">
								<div class="span12">
