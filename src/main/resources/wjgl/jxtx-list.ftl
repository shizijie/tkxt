...
<@crudmetropage3>
	<form id="query_form" action="${base}/wjgl/jxtx.action" method="post">
						...
						<div class="portlet box green">
							...
							<div class="portlet-body">
							 <!-- 在这里编写查询条件 -->
						  		<div class="left">
									题型名称
									<input type="text" class="m-wrap span12" id="filter_LIKES_txmc" name="filter_LIKES_txmc"  value="${Parameters['filter_LIKES_txmc']?if_exists}" maxlength="1000"/>
								</div>
								<center>
							...
							<div class="portlet-body">
								...
								<#list page.result as obj>
									...
									<tr title="${obj.id}">
										 ...
										 <td>
									 		<a class="btn mini purple" href="javascript:;" onclick="window.open('${base}/wjgl/jxtx!input.action?id=${obj.id}')"><i class="icon-edit"></i> 修改</a>
										 </td>
									</tr>
								</#list>
								</table>									
								...
								<script type="text/javascript">
									...
									function add()
									{
											window.open('${base}/wjgl/jxtx!input.action');
									}
									
									$('#query_form').pfwpage({
										page_button:[
											{b_name:'新增',b_function:add,bclass:'btn green',bicon:'icon-pencil'},
											{b_name:'删除',opttype:'delete',bclass:'btn red',bicon:'icon-trash',b_url:'${base}/wjgl/jxtx!delete.action',confirmStr:'是否确认删除？',paramName:'checks',selectNum:'^[0-9]*[1-9][0-9]*$'}
										],
										page_col:
										[
